...
export interface ApiScheduleSlotScheduleSlot
  ...
  info: {
    description: 'Weekly time slot for a show';
...
export interface ApiShowShow extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Radio show or program';
    displayName: 'Show';
    pluralName: 'shows';
    singularName: 'show';
  };
  ...
  attributes: {
    ...
    isLiveShow: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::show.show'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    schedule_slots: Schema.Attribute.Relation<
      'oneToMany',
      'api::schedule-slot.schedule-slot'
    >;
